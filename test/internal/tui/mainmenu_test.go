...
func TestMainMenu_SettingsNavigationWraps(t *testing.T) {
	const numItems = 10 // claude tool has 10 settings items (incl. Theme, Panel, Usage bars, Plan, Login, Auto-switch accounts rows)
...
func TestSettings_NavWrapsWithTenItems(t *testing.T) {
	// claude tool shows 10 settings items (Mascot, Tab title, Sound, Panel,
...
func TestSettings_NavWrapsWithTenItems_NonClaude(t *testing.T) {
